...
Unutmayın SYAT9 sıradan bir bot değildir VIP bot olan SYAT9i sizlere armağan ediyorum
...
client.ayarlar = {
  oynuyor: "!!yardım",
  official_sahip: "519236223899009037",
  sahip: "519236223899009037",

  yardimcilar: [""],
  isim: "SYAT9",
  botD:
    "https://discord.com/oauth2/authorize?client_id=524202201774686208&scope=bot&permissions=8589934591",
  webS: "http://syat9.sayware.net/",
  web: "http://syat9.sayware.net/",
  site: "http://syat9.sayware.net/",
  dblO: "",
  dbl: "",
  dbltoken:
        "",
  webpanel: "http://syat9.sayware.net/",
  versiyon: "2.0",
  prefix: "!!",
  renk: "RANDOM",
  version: "1.0.0"
...
client.on("guildCreate", guild => {
  const e = new Discord.RichEmbed()
    .setColor("RANDOM")
    .setDescription(
      "Hey, ben SYAT9. Az önce beni ekledin.\n!!yardım yazarak bilgi alabilirsin."
    )
...
let i = db.fetch(`üyelikk_${msg.author.id}`)
  ...
  .setAuthor(`SYAT9`,`${msg.author.avatarURL || msg.author.displayAvatarURL}`)
...
Bu iyliğimi unutmayın hata olursa Cod are daha detaylı zor hata olursa Yusuf K Dev.#3004 ulaşınız  
Botu kuramadıysanız kimseye ücret vermeyin kurulumunu cod are yapar.*/
client.login("NTI0MjAyMjAxNzc0Njg2MjA4");
