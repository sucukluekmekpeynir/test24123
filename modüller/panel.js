...
module.exports = (client) => {
  ...
  const bilgiler = {
    oauthSecret: "qshMk733VNoHbWzQ_7J_TJZ8ATHcpqYh",
    callbackURL: `https://syat9.sayware.net/callback`,
    domain: `https://syat9.sayware.net/`
  };
...
res.redirect("/panel/"+req.params.guildID+"/genel");
  ...
  app.get("/ekle", (req, res) => {
   ...
   app.get("/seviye", (req, res) => {
    res.redirect(`https://syat9.sayware.net/kullanici/${req.params.kullaniciID}/yonet`);
  });
